...
public class OrderService(IUnitOfWork uow, IPublishEndpoint bus, IMapper mapper)
    : GenericService<Order, OrderDto>(uow.Orders, uow, mapper), IOrderService
{
    ...
    public override async Task<OrderDto?> GetByIdAsync(long id)
    {
    ...
    public override async Task<OrderDto> CreateAsync(OrderDto request)
    {
    ...
    public override async Task<bool> UpdateAsync(long id, OrderDto request)
    {
